...
namespace Proyecto1_TBD2.Cheks {
    public partial class CrearChecks:Form {
        TreeView arbol;
        public CrearChecks(TreeView _arbol) {
            InitializeComponent();
            arbol = _arbol;
        }

        private void CrearChecks_Load(object sender, EventArgs e) {
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e) {
            try {
                richTextBox1.Text = "ALTER TABLE " + comboBox1.SelectedItem.ToString() + " ADD CONSTRAINT "  + textBox1.Text + " CHECK (" + richTextBox2.Text+");";
